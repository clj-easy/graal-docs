...
2. Create a project
    ...
    Optionally create a `deps.edn` to explicitly select the current Clojure release.
    While not required for this hello world app, the current Clojure release contains some important fixes for GraalVM:
