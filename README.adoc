...
Use Clojure https://clojure.org/community/devchangelog#_release_1_10_2[1.10.2-alpha1], it contains several GraalVM specific fixes, including:
...
The following are also tagged for an upcoming Clojure 1.10.2 release:
