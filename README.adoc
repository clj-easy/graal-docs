...
____
:wave: Need help or want to chat?
...
== xref:doc/hello-world.adoc[Hello world]
...
Make sure you put `(set!
*warn-on-reflection* true)` at the top of every namespace in your project to get rid of all reflection.
