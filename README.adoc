...
The recommended caller based filter, to not get lots of false positives in the
generated config, is:
...
pull in XML libraries due to its `storeToXML` methods. To exclude this class,
you can use an
