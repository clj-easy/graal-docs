...
* https://clojure.atlassian.net/browse/CLJ-2582 - Improve GraalVM native image size / compile time memory consumption when compiling clojure.pprint
* https://clojure.atlassian.net/browse/TCHECK-157 - Randomization doesn't work with GraalVM native-image
