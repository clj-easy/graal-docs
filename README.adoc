...
If you are using GraalVM v21 or later, you can skip this tip.

GraalVM started supporting JDK11 in v19.3.0.
From this version until v21, GraalVM could get confused about a https://github.com/clojure/clojure/blob/653b8465845a78ef7543e0a250078eea2d56b659/src/jvm/clojure/lang/Reflector.java#L29-L57[conditional piece of code] in `clojure.lang.Reflector` which dispatches on Java 8 or a later Java version.
