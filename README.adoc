...
=== Optimizing for dynaload

If your project makes use of https://github.com/borkdude/dynaload[dynaload], you'll want to follow its advice for https://github.com/borkdude/dynaload#graalvm[GraalVM].
